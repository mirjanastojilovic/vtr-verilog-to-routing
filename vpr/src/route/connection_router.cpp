...
void ConnectionRouter<Heap>::timing_driven_expand_neighbour(t_heap* current,
    ...
    if ((to_xlow < bounding_box.xmin    // Strictly left of BB left-edge
         || to_xlow > bounding_box.xmax // Strictly right of BB right-edge
         || to_ylow < bounding_box.ymin // Strictly below BB bottom-edge
        ...
        VTR_LOGV_DEBUG(router_debug_,
                       ...
                       rr_graph_->node_xhigh(to_node), rr_graph_->node_yhigh(to_node), to_layer,
